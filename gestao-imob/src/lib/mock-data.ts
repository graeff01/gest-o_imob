...
export const MOCK_EMPLOYEES: any[] = [
  { id: "emp-001", cpf: "12345678901", position: "CONSULTOR", department: "LOCACAO", contract_type: "CLT", is_active: true, user: { name: "Lucas Rodrigues", email: "lucas.rodrigues@moinhosimob.com.br" } },
  { id: "emp-002", cpf: "23456789012", position: "CONSULTOR", department: "VENDA", contract_type: "CLT", is_active: true, user: { name: "Thiago Lima", email: "thiago.lima@moinhosimob.com.br" } },
  { id: "emp-003", cpf: "34567890123", position: "CAPTADOR", department: "LOCACAO", contract_type: "CONTRACT", is_active: true, user: { name: "Fernanda Souza", email: "fernanda.souza@moinhosimob.com.br" } },
  { id: "emp-004", cpf: "45678901234", position: "RECEPCAO", department: "ADMIN", contract_type: "CLT", is_active: true, user: { name: "Ana Paula Müller", email: "ana.muller@moinhosimob.com.br" } },
  { id: "emp-005", cpf: "56789012345", position: "CONSULTOR", department: "LOCACAO", contract_type: "CLT", is_active: true, user: { name: "Roberto Costa", email: "roberto.costa@moinhosimob.com.br" } },
  { id: "emp-006", cpf: "67890123456", position: "GERENTE", department: "ADMIN", contract_type: "CLT", is_active: true, user: { name: "Carla Mendonça", email: "carla.mendonca@moinhosimob.com.br" } },
];
...
export const MOCK_PROPERTIES: any[] = [
  { id: "prop-001", via_code: "MV-1200", address_street: "Av. Independência", address_number: "1200", address_complement: "Ap 301", address_neighborhood: "Moinhos de Vento", property_type: "APARTAMENTO", status: "LOCADO", rent_value: "4000", sale_value: null, owner: { name: "Maria Aparecida Lima" } },
  { id: "prop-002", via_code: "MV-0302", address_street: "Rua Padre Chagas", address_number: "302", address_complement: "Sala 5", address_neighborhood: "Moinhos de Vento", property_type: "SALA", status: "DISPONIVEL", rent_value: "6000", sale_value: null, owner: { name: "Carlos Eduardo Souza" } },
  { id: "prop-003", via_code: "MV-0555", address_street: "R. Mostardeiro", address_number: "555", address_complement: "Ap 12", address_neighborhood: "Moinhos de Vento", property_type: "APARTAMENTO", status: "LOCADO", rent_value: "3000", sale_value: null, owner: { name: "Roberto Almeida Costa" } },
  { id: "prop-004", via_code: "MV-0077", address_street: "Av. Goethe", address_number: "77", address_complement: "Cobertura", address_neighborhood: "Moinhos de Vento", property_type: "APARTAMENTO", status: "LOCADO", rent_value: "10000", sale_value: null, owner: { name: "Lucia Hoffmann" } },
  ...
  { id: "prop-010", via_code: "MV-0078", address_street: "Rua Quintino Bocaiúva", address_number: "78", address_complement: null, address_neighborhood: "Moinhos de Vento", property_type: "CASA", status: "DISPONIVEL", rent_value: "8500", sale_value: null, owner: { name: "Lucia Hoffmann" } },
...
export const MOCK_CAMPAIGNS: any[] = [
  ...
  { id: "camp-002", name: "Captação Imóveis Premium — Moinhos", campaign_type: "CAPTACAO", start_date: "2026-03-01", end_date: null, reward_type: "FIXO", reward_amount: "50", status: "ATIVA" },
